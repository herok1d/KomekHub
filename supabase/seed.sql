...
begin
  ...
  values
    ...
    ('66666666-6666-4666-8666-666666666666', demo_owner, 'Bilim Bridge', 'Education foundation supporting inclusive learning and online tutoring for regions.', 'Online', null, 'learn@bilimbridge.kz', 'https://bilimbridge.kz'),
  ...
  insert into public.opportunities (
    ...
    languages, badges, requirements, benefits, volunteer_hours, certificate_available
  )
  values
    ('aaaaaaaa-0001-4000-8000-000000000001', '11111111-1111-4111-8111-111111111111', 'Student mentor for school students', 'Mentor high school students in Astana on study planning, confidence, and university pathways.', 'Astana', 'Education', 'Hybrid', 'Part-time', array['Kazakh','Russian'], array['Student-friendly','Certificate'], 'Communication skills, reliability, weekly availability.', 'Mentor training, certificate, verified volunteer hours.', 36, true),
    ('aaaaaaaa-0002-4000-8000-000000000002', '22222222-2222-4222-8222-222222222222', 'Eco cleanup volunteer', 'Join a weekend cleanup in Almaty parks and help run a recycling awareness booth.', 'Almaty', 'Environment', 'Offline', 'Weekend', array['Kazakh','Russian'], array['Weekend','Certificate','No experience needed'], 'Comfortable outdoor work.', 'Outdoor teamwork, environmental impact, certificate.', 8, true),
    ('aaaaaaaa-0003-4000-8000-000000000003', '33333333-3333-4333-8333-333333333333', 'University conference event volunteer', 'Help guests, speakers, and students at an education and technology conference.', 'Astana', 'Events', 'Offline', 'Project', array['Russian','English'], array['Student-friendly','Certificate','English language'], 'Friendly communication and punctuality.', 'Networking, 16 volunteer hours, certificate.', 16, true),
    ('aaaaaaaa-0004-4000-8000-000000000004', '44444444-4444-4444-8444-444444444444', 'Charity food distribution', 'Prepare and distribute food packages for families and elderly people in Shymkent.', 'Shymkent', 'Charity', 'Offline', 'Weekend', array['Kazakh','Russian'], array['Urgent','Weekend','No experience needed'], 'Respectful communication and reliability.', 'Direct community impact and team experience.', 12, false),
    ('aaaaaaaa-0005-4000-8000-000000000005', '66666666-6666-4666-8666-666666666666', 'Online language tutoring volunteer', 'Tutor school students online in English, Kazakh, or Russian.', 'Online', 'Education', 'Online', 'Flexible', array['Kazakh','Russian','English'], array['Online','Student-friendly','Certificate','Flexible schedule'], 'Confident in at least one supported language.', 'Flexible schedule, certificate, tutoring experience.', 24, true),
    ('aaaaaaaa-0006-4000-8000-000000000006', '88888888-8888-4888-8888-888888888888', 'Animal shelter care assistant', 'Help an Almaty shelter with walking, feeding, cleaning, and adoption days.', 'Almaty', 'Animals', 'Offline', 'Part-time', array['Russian'], array['Weekend','No experience needed'], 'Comfortable around dogs and cats.', 'Animal care experience and shelter team training.', 10, false),
    ...
    ('aaaaaaaa-0010-4000-8000-000000000010', '77777777-7777-4777-8777-777777777777', 'Tech volunteer for nonprofit digitalization', 'Help a nonprofit organize forms, dashboards, website content, or documentation.', 'Online', 'IT & Digital', 'Online', 'Flexible', array['Russian','English'], array['Online','Student-friendly','Certificate','English language'], 'Basic web, spreadsheet, or no-code skills.', 'Portfolio case, certificate, recommendation note.', 28, true),
    ('aaaaaaaa-0011-4000-8000-000000000011', '44444444-4444-4444-8444-444444444444', 'Youth debate club facilitator', 'Facilitate debate sessions for teenagers and public speaking practice.', 'Kyzylorda', 'Youth', 'Offline', 'Few hours', array['Kazakh','Russian'], array['Student-friendly','Kazakh language'], 'Public speaking interest.', 'Facilitation practice and volunteer hours.', 14, false),
    ('aaaaaaaa-0012-4000-8000-000000000012', '11111111-1111-4111-8111-111111111111', 'Community elder support calls', 'Make friendly check-in calls to elderly people and flag support needs.', 'Online', 'Community', 'Online', 'Flexible', array['Kazakh','Russian'], array['Online','Certificate','Flexible schedule'], 'Warm phone communication.', 'Flexible online role and certificate.', 16, true),
    ...
    ('aaaaaaaa-0016-4000-8000-000000000016', '66666666-6666-4666-8666-666666666666', 'Online English speaking buddy', 'Help regional students practice conversational English online.', 'Online', 'Education', 'Online', 'Few hours', array['English','Russian'], array['Online','Student-friendly','Flexible schedule','English language'], 'Comfortable conversational English.', 'Remote schedule and tutoring experience.', 18, false),
